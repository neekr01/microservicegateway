...
```
$ docker image tag microservicegateway dockerrepo/microservicegateway
$ docker push dockerrepo/microservicegateway
```
...
```
$ kubectl get svc microservicegateway -n microservicegateway
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n microservicegateway
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n microservicegateway
```
...
```
$ kubectl get svc jhipster-console -n microservicegateway
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n microservicegateway
```

and explore the details using

```
$ kubectl get svc exposed-registry -n microservicegateway
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n microservicegateway
```
